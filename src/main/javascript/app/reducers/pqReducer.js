...
export default function reducer(state = {
    ...
    switch (action.type) {
        ...
        case 'FETCH_PQ_SUCCES': {
            ...
            const columns_without_color = _.filter(state.columns.items, column => state.colors.items[column] === undefined)
            ...
            const new_colors_items = Object.assign(state.colors.items, ...nonprovided_colors)
            return {
                ...state,
